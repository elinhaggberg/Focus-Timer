import { getFocusTimers, getTodoLists, getLastSeenVersion, setLastSeenVersion } from "./storage.js";
...
export function checkWhatsNew() {
  ...
  const isFreshInstall = !lastSeen && getFocusTimers().length === 0 && getTodoLists().length === 0;
