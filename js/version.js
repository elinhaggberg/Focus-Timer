...
export const CHANGELOG = [
  {
    ...
    date: "July 19, 2026",
    changes: [
      "Full backups now also include your theme, home screen title, and sound settings, not just timers and to-do lists — if you've exported one before, it's worth making a fresh one.",
